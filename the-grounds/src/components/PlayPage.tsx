...
  // The useUser hook destructuring was empty in your provided code, so I'm keeping it as is.
  // If you need isFirstTime, name, or email later, you'll need to uncomment them.
  const { } = useUser(); 
...
  };
  
  // Removed duplicated and commented out useEffect for first time setup
  
  // Merged timer useEffect (was duplicated)
  useEffect(() => {
...
    setShowSaveAs(false);
    setShowResults(true);
    playCongratsMessage(); // Play the congratulatory message after saving
  };
